	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.points}">
				<li class="fieldcontain">
					<span id="points-label" class="property-label"><g:message code="person.points.label" default="Points" /></span>
					
						<span class="property-value" aria-labelledby="points-label"><g:fieldValue bean="${personInstance}" field="points"/></span>
				...
				<g:if test="${personInstance?.webPage}">
				<li class="fieldcontain">
					<span id="webPage-label" class="property-label"><g:message code="person.webPage.label" default="Web Page" /></span>
					
						<span class="property-value" aria-labelledby="webPage-label"><g:fieldValue bean="${personInstance}" field="webPage"/></span>
