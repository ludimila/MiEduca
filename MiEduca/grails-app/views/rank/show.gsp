	...
	<body>
		...
		<div id="show-rank" class="content scaffold-show" role="main">
			...
			<ol class="property-list rank">
				...
				<g:if test="${rankInstance?.users}">
				<li class="fieldcontain">
					<span id="users-label" class="property-label"><g:message code="rank.users.label" default="Users" /></span>
					
						<g:each in="${rankInstance.users}" var="u">
