	...
	<body>
		...
		<div id="show-area" class="content scaffold-show" role="main">
			...
			<ol class="property-list area">
				...
				<g:if test="${areaInstance?.courses}">
				<li class="fieldcontain">
					<span id="courses-label" class="property-label"><g:message code="area.courses.label" default="Courses" /></span>
					
						<g:each in="${areaInstance.courses}" var="c">
